 ...
 <!-- Header -->
    <header class="header">
        ...
        <div class="deco-white-circle-1">
            <img src="<?=ASSETS?>images/decorative-white-circle.svg" alt="alternative">
        </div> <!-- end of deco-white-circle-1 -->
        <div class="deco-white-circle-2">
            <img src="<?=ASSETS?>images/decorative-white-circle.svg" alt="alternative">
        </div> <!-- end of deco-white-circle-2 -->
        <div class="deco-blue-circle">
            <img src="<?=ASSETS?>images/decorative-blue-circle.svg" alt="alternative">
        </div> <!-- end of deco-blue-circle -->
        <div class="deco-yellow-circle">
            <img src="<?=ASSETS?>images/decorative-yellow-circle.svg" alt="alternative">
        </div> <!-- end of deco-yellow-circle -->
        <div class="deco-green-diamond">
            <img src="<?=ASSETS?>images/decorative-green-diamond.svg" alt="alternative">
        </div> <!-- end of deco-yellow-circle -->
    ...
    <div id="description" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=ASSETS?>images/description-1-app.png" alt="alternative">
	...
	<div id="description-1-details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
			...
			<div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="<?=ASSETS?>images/description-1-details-lightbox.jpg" alt="alternative">
                </div> <!-- end of image-container -->
			</div>
			<div class="col-lg-4">
                <h3>Goals Setting</h3>
    ...
    <div class="tabs">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=ASSETS?>images/description-2-app.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div id="features" class="basic-2">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <img class="img-fluid" src="<?=ASSETS?>images/features-app.jpg" alt="alternative">
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-1.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-1.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-2.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-2.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-3.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-3.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-4.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-4.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-5.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-5.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-1.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-6.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-2.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-7.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-3.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-8.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-4.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-9.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <a href="<?=ASSETS?>images/screenshot-5.jpg" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="<?=ASSETS?>images/screenshot-10.jpg" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
    ...
    <div id="download" class="basic-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=ASSETS?>images/download-iphone.png" alt="alternative">
                    </div> <!-- end of image-container -->
